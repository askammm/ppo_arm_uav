...
gnome-terminal --tab --title="n3" -- bash -c "docker exec -it -w \"$ROOT_PATH\" \"$CONTAINER_NAME\" bash -lc 'source devel/setup.bash && echo ROS DISTRO: \$ROS_DISTRO && roslaunch m4e_mani_base sarax_plus_sitl.launch'; exec bash"
